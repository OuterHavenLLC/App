<?php
 ...
 if($api == "Design") {
  ...
  if($command[0] == "Error") {
   ...
   if(!empty($command[1])) {
    $content = "v=".base64_encode("WebUI:Public")."&Type=Public&View=".base64_encode("v=".base64_encode("Search:ReSearch")."&query=".base64_encode($command[1]));
   }
   ...
   # TOPICS
   $content = "v=".base64_encode("WebUI:Public")."&Type=Public&View=".base64_encode("v=".base64_encode("Search:ReSearch")."&query=".base64_encode("#FreedomAlwaysWins"));
   if(!empty($command[1])) {
    $content = "v=".base64_encode("WebUI:Public")."&Type=Public&View=".base64_encode("v=".base64_encode("Search:ReSearch")."&query=".base64_encode("#".$command[1]));
   }
  } else {
